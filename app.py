...
st.markdown("""
    ...
    /* 🚀 THE ARROW FIX: Replaces the glitch text with a clean Arrow sign */
    ...
    /* Surgical strike on the 'keyboard_double' text to replace it with ➔ */
    [data-testid="collapsedControl"] span {
        font-size: 0px !important; /* Hide the old text */
    }
    
    [data-testid="collapsedControl"] span::before {
        content: "➔" !important; /* Insert the Arrow sign */
        font-size: 24px !important;
        color: #9b72cb !important;
        display: block !important;
    }
